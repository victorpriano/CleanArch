...
public class MemberConfiguration : IEntityTypeConfiguration<Member>
{
    public void Configure(EntityTypeBuilder<Member> builder)
    {
        ...
        // Insere dados iniciais no banco ao executar a migration
        builder.HasData(
            new Member(1, "Janis", "Joplin", "feminino", "janis@gmail.com", true),
            new Member(2, "Elvis", "Presley", "masculino", "elvis@gmail.com", true)
        );
    }
}